...
function updateInteractive()
  object.setInteractive(config.getParameter("interactive", true) and not self.sensorConfig and not storage.locked)
end
...
function hasCapability(capability)
  ...
  elseif storage.locked or self.sensorConfig then
    return false
